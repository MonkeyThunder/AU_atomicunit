...
setup(
    ...
    description         = 'Convert between Atomic unit and SI unit package',
    # 배포하는 사람의 이름을 작성합니다.
    author              = 'D.H kim',
    # 배포하는 사람의 메일주소를 작성합니다.
    author_email        = 'monkeythunder91@gmail.com',
    # 배포하는 패키지의 url을 적어줍니다. 보통 github 링크를 적습니다.
    url                 = 'https://github.com/monkeythunder91/AU_atomicunit',
    # 배포하는 패키지의 다운로드 url을 적어줍니다.
    download_url        = 'https://github.com/monkeythunder91/AU_atomicunit/archive/master.zip',
    ...
    # 패키지의 키워드를 적습니다.
    keywords            = ['hatree', 'atomic unit', 'atomicunit'],
